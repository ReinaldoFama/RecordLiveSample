        ...
        if(checkPermissionFromDevice())
        {
            ...
            stpg.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    stpr.setEnabled(false);
                    Toast.makeText(dashboard.this, "Gravação parada...", Toast.LENGTH_SHORT).show();
            ...
            plar.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    mediaPlayer.start();
                    Toast.makeText(dashboard.this, "Reproduzindo áudio...", Toast.LENGTH_SHORT).show();
                }
            });
            ...
            stpr.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    stpr.setEnabled(false);
                    plar.setEnabled(true);
                    Toast.makeText(dashboard.this, "Reprodução parada...", Toast.LENGTH_SHORT).show();
